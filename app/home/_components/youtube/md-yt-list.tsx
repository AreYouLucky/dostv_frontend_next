'use client'
import TopYouTubeExpanding from "@/components/ui/top-youtube/top-yt";
import { TopCount } from "@/types/models";

function MdYtList({data}: {data: TopCount}) {

    return (
        <div className="w-full mb-4 block md:py-6 lg:py-8 lg:px-6 overflow-hidden bg-black/70 ">
