...
export default function BannerCardElements({ banner }:{ banner: BannerModel }) {
    return (
        <div className="grid h-55 md:h-80 lg:h-120 w-full grid-cols-2 lg:grid-cols-5 md:gap-4 lg:gap-8 gap-3 p-3 md:p-6 lg:p-12 bg-linear-to-l from-black/10 to-black/90">
            ...
            <div className="flex items-center justify-end lg:col-span-3  ">
                {banner?.type && [2, 3].includes(banner?.type) && (
                    <Image
                        ...
                        className="w-full h-auto max-h-96 max-w-3xl overflow-hidden rounded-lg object-cover shadow-sm lg:shadow-md shadow-[#00aeef]  hover:shadow-xl hover:scale-105 duration-300"
                    />
