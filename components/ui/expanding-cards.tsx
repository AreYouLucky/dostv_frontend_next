                            ...
                            <div className="absolute inset-0 flex flex-col justify-end text-white">
                                ...
                                >
                                    ...
                                    <Link
                                        ...
                                        className=""
                                    >
                                        <div className="flex flex-row gap-3 fade-up bg-black/60 rounded-lg lg:py-3 py-2 px-2 lg:px-4  fade-up  items-start md:mb-2 hover:bg-black transition border border-[#00aeef]/40 ">
                                            <div className=" text-center flex flex-col justify-center gap-1 items-center">
                                                ...
                                                <span className="text-[10px] md:text-[10px] text-slate-300 rounded-md py-0.5 px-2 bg-[#004a95] inline-block">
                                                    {card.view_count}
                                                </span>
                                            </div>
                                ...
                                >
                                    <div className=" text-center flex flex-col justify-center gap-1 items-center">
                                        ...
                                        <span className="text-[7px] md:text-[11px] font-semibold text-slate-300 rounded-md py-0.5 px-2 bg-[#ffffff]/20 inline-block">
                                            {card.view_count}
                                        </span>
                                    </div>
                                </motion.div>
